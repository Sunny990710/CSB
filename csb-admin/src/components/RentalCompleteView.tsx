...
export default function RentalCompleteView({ agreement, onContinue, onViewStatus }: RentalCompleteViewProps) {
  const rows: { label: string; value: React.ReactNode; valueClass?: string }[] = [
    ...
    { label: '대여자', value: agreement.borrowerName, valueClass: 'text-slate-900' },
